// ================= CONFIG =================
const CONFIG = {
  BIN_ID: "69d255a8856a682189ffbba8",
  API_KEY: "$2a$10$HSdyWxkoHRvw8WW4pgFIsu.2n770vint7YnkPbh10QIsvW5VeLf/e"
};
...
function checkout() {
  ...
  const url = `pembayaranff.html?game=ff&id=${encodeURIComponent(userId)}&produk=${encodeURIComponent(selectedProduct.name)}&harga=${selectedProduct.price}`;

  window.location.href = url;
}

// ================= FINAL (OPSIONAL STEP DI HALAMAN INI) =================
...
function sendWhatsApp() {
  const userId = document.getElementById("userId").value.trim();
  const phone = "628xxxxxxxxxx"; // GANTI
